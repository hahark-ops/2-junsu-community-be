...
ensure_key REDIS_URL "redis://redis:6379/0"
...
ensure_key UPLOAD_INTERNAL_TOKEN ""
...
ensure_key WEB_PUSH_VAPID_PUBLIC_KEY ""
ensure_key WEB_PUSH_VAPID_PRIVATE_KEY ""
ensure_key WEB_PUSH_SUBJECT "mailto:admin@example.com"
